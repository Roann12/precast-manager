# File overview: ORM models and persistence mapping for app/models/dispatch_item.py.
...
class DispatchItem(Base):
    ...
    yard_inventory_id = Column(Integer, ForeignKey("yard_inventory.id"))

    quantity = Column(Integer, nullable=False)

    dispatch = relationship("DispatchOrder", back_populates="items")

    yard_inventory = relationship("YardInventory")